...
export default function DoctorDashboard() {
  ...
  // Doctor's specific navigation links (Updated to include EMR Form)
  const doctorNavLinks = [
    { name: 'Profile', href: '/dashboard/doctor/profile' },
    { name: 'Appointments', href: '/dashboard/doctor/appointments' },
    { name: 'Patients', href: '/dashboard/doctor/patients' },
    { name: 'New EMR', href: '/dashboard/doctor/emr-form' },
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="container mx-auto py-12 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* Profile Card */}
          <div className="bg-white p-6 rounded-lg shadow-md transition-transform duration-300 hover:scale-105 border-l-4 border-blue-500">
            <h2 className="text-2xl font-semibold mb-4 text-blue-600">My Profile</h2>
            <p className="text-gray-600 mb-4">View and update your professional information and credentials.</p>
            <Link href="/dashboard/doctor/profile" className="text-blue-500 hover:underline font-semibold">
              View Profile &rarr;
          ...
          {/* EMR Creation/Upload Card (NEW) */}
          <div className="bg-white p-6 rounded-lg shadow-md transition-transform duration-300 hover:scale-105 border-l-4 border-red-500">
            <h2 className="text-2xl font-semibold mb-4 text-red-600">Create New EMR</h2>
            <p className="text-gray-600 mb-4">Digitally record patient diagnosis, prescriptions, and upload documents.</p>
            <Link href="/dashboard/doctor/emr-form" className="text-red-500 hover:underline font-semibold">
              Start EMR Process &rarr;
            </Link>
          </div>
          
          {/* Appointments Card */}
          <div className="bg-white p-6 rounded-lg shadow-md transition-transform duration-300 hover:scale-105 border-l-4 border-green-500">
            <h2 className="text-2xl font-semibold mb-4 text-green-600">Appointments</h2>
            <p className="text-gray-600 mb-4">View and manage your upcoming appointments and patient schedules.</p>
            <Link href="/dashboard/doctor/appointments" className="text-green-500 hover:underline font-semibold">
              View Appointments &rarr;
          ...
          {/* Patients Card */}
          <div className="bg-white p-6 rounded-lg shadow-md transition-transform duration-300 hover:scale-105 border-l-4 border-purple-500">
            <h2 className="text-2xl font-semibold mb-4 text-purple-600">My Patients</h2>
            <p className="text-gray-600 mb-4">Access a list of your patients and their medical records.</p>
            <Link href="/dashboard/doctor/patients" className="text-purple-500 hover:underline font-semibold">
              View Patients &rarr;
